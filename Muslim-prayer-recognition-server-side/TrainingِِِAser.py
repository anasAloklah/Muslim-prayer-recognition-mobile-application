...
#Sitting = df[df['activity'] == 'Sitting'].head(1500).copy()
#Prostartion = df[df['activity'] == 'Prostration'].copy()
...
# In[38]:
#X = X.reshape(2748, 80, 3, 1)
#X = X.reshape(3057, 80, 3, 1)#isha
X = X.reshape(2306, 80, 3, 1)#magrab
#X_train = X_train.reshape(2198, 80, 3, 1)
#X_train = X_train.reshape(2445, 80, 3, 1)#isha
#X_test = X_test.reshape(550, 80, 3, 1)
#X_test = X_test.reshape(612, 80, 3, 1)#isha

X_train = X_train.reshape(1844, 80, 3, 1)#magrab
X_test = X_test.reshape(462, 80, 3, 1)#magrab
